...
def fetch_ohlcv_placeholder(symbol: str, timeframe: str = "1m", limit: int = 2000) -> pl.DataFrame:
    ...
    for i in range(limit):
        ...
        high = price * 1.001
        low = price * 0.999
        data.append(Kline(ts=i, open=price, high=high, low=low, close=price, volume=1000.0))
