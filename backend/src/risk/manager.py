...
class RiskManager:
    ...
    def __init__(self, policy: RiskPolicy | None = None, base_equity: float = 10000.0):
        ...
        self.book = EquityBook(equity_start_day=base_equity, equity_now=base_equity)
    ...
    def calc_position_size(
        self, symbol: str, prob_up: float, confidence: float, vol_annual: float
    ) -> float:
        """
    ...
    def on_order_filled(
        self, symbol: str, side: str, notional: float, realized_pnl: float = 0.0
    ) -> None:
        """
