...
def replay_status() -> dict[str, Any]:
    ...
    report_path = os.getenv("REPLAY_REPORT_PATH", "backend/data/reports/replay_latest.json")
    ...
    try:
        ...
        return {
            "ok": True,
            "status": "success" if data.get("drift_detection", {}).get("tolerance_ok", False) else "drift_detected",
            "data": data,
