...
class RsiMacdFeatureCache:
    ...
    def update(self, price: float, high: float, low: float, rsi_period: int = 14,
        ...
        macd_hist_crossed_up = prev_macd_hist <= 0.0 and self.last_macd["histogram"] > 0.0
        macd_hist_crossed_down = prev_macd_hist >= 0.0 and self.last_macd["histogram"] < 0.0
