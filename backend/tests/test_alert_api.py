...
def test_get_alert_history_with_data(monkeypatch, tmp_path):
    ...
    with open(alert_file, "w", encoding="utf-8") as f:
        f.write(json.dumps({"title": "Alert 1", "severity": "high", "timestamp": "2025-10-05T10:00:00Z"}) + "\n")
        f.write(json.dumps({"title": "Alert 2", "severity": "info", "timestamp": "2025-10-05T11:00:00Z"}) + "\n")
...
def test_alert_history_filter_severity(monkeypatch, tmp_path):
    ...
    with open(alert_file, "w", encoding="utf-8") as f:
        f.write(json.dumps({"title": "Alert 1", "severity": "high", "timestamp": "2025-10-05T10:00:00Z"}) + "\n")
        f.write(json.dumps({"title": "Alert 2", "severity": "info", "timestamp": "2025-10-05T11:00:00Z"}) + "\n")
        f.write(json.dumps({"title": "Alert 3", "severity": "high", "timestamp": "2025-10-05T12:00:00Z"}) + "\n")
